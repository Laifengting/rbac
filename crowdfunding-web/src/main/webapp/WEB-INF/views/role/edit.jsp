        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    <div><a class="navbar-brand" style="font-size:32px;" href="${APP_PATH}/main">众筹平台 - 角色修改</a></div>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form id="roleForm" role="form">
                                ...
                                <button id="updateBtn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i> 修改
                                </button>
                ...
                $("#updateBtn").click(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.success) {
                                layer.msg("修改角色信息成功", {time: 1000, shift: 6}, function () {
                                    window.location.href = "${APP_PATH}/role/index";
                                });
                            } else {
                                layer.msg("修改角色信息失败", {time: 2000, icon: 5, shift: 6}, function () {
                                });
                            }
                        }
                    });
