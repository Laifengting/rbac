                        ...
                        <div class="panel-body">
                            <form role="form" id="permissionForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="permissionurl" value="${permission.url}"
                                           placeholder="请输入许可链接地址">
                                </div>
                                <button id="updateBtn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 修改
                                </button>
                                <button type="button" id="resetBtn" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 重置
                                </button>
                            </form>
                        </div>
                    </div>
                ...
                $("#updateBtn").click(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.success) {
                                layer.msg("修改许可信息成功", {time: 1000, shift: 6}, function () {
                                    window.location.href = "${APP_PATH}/permission/index";
                                });
                            } else {
                                layer.msg("修改许可信息失败", {time: 2000, icon: 5, shift: 6}, function () {
                                });
                            }
                        }
